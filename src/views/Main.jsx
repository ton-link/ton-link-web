...
const Main = () => {
  ...
  async function removeStakeButton() {
    let req = await fetch(
      `https://api.tonlink.xyz/api/removeStake?address=${localStorage.getItem(
        "address"
      )}`
    );
  ...
  async function withdrawStakeButton() {
    let req = await fetch(
      `https://api.tonlink.xyz/api/withdraw?address=${localStorage.getItem(
        "address"
      )}`
    );
    const res = await req.json();
  ...
  async function pauseButton() {
    let req = await fetch(
      `https://api.tonlink.xyz/api/pause?address=${localStorage.getItem(
        "address"
      )}`
    );
    const res = await req.json();
  ...
  async function cancelPauseButton() {
    let req = await fetch(
      `https://api.tonlink.xyz/api/cancelPause?address=${localStorage.getItem(
        "address"
      )}`
    );
    const res = await req.json();
